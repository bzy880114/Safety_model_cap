        ...
        with tf.Session(graph=detection_graph, config=config) as sess:
            ...
            while True:
                ...
                if ret == True:
                    ...
                    detect_area = np.array([[600, 100],[200,200],[200,600],[600, 600],[600,200]], np.int32)
                    detect_area = detect_area.reshape(1,-1,2)
...
#                    proc.stdin.write(image_np.tobytes())
                    if not type(detect_area) == type(False):
                        cv2.polylines(image_np,[detect_area.reshape(-1,1,2)],True,(0,255,255),2)
