...
STANDARD_COLORS = ['AliceBlue', 
    'Green', 'Red', 'Chartreuse', 'Aqua', 'Aquamarine', 'Azure',
    ...
    'RosyBrown', 'RoyalBlue', 'SaddleBrown', 'SandyBrown', 'Bisque', 'Beige',
...
#    # 自定义bzy
#    draw.rectangle(
#        [((right - text_width), (top + bottom)/2 - text_height - 2 * margin),
#         ((right - text_height) + text_height, (top + bottom)/2)],
#        fill=color)
    draw.text(
...
#    # 自定义bzy
#    draw.text(
#        ((right - text_width) + margin, (top + bottom)/2 - text_height - margin),
#        display_str,
#        fill='black',
#        font=font)
